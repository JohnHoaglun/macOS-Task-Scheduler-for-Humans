...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        self._filter_controls.setVisible(False)
        self.view_menu = self.menuBar().addMenu("View")
        self.show_filters_action = QAction("Show Filters", self)
        self.show_filters_action.setCheckable(True)
        self.show_filters_action.setChecked(False)
        self.show_filters_action.toggled.connect(self._filter_controls.setVisible)
        self.view_menu.addAction(self.show_filters_action)
        self.panel.setVisible(False)
        self.history_panel.setVisible(False)
        self.show_diagnostics_action = QAction("Show Diagnostics", self)
        self.show_diagnostics_action.setCheckable(True)
        self.show_diagnostics_action.setChecked(False)
        self.show_diagnostics_action.toggled.connect(self.panel.setVisible)
        self.view_menu.addAction(self.show_diagnostics_action)
        self.show_history_action = QAction("Show History", self)
        self.show_history_action.setCheckable(True)
        self.show_history_action.setChecked(False)
        self.show_history_action.toggled.connect(self.history_panel.setVisible)
        self.view_menu.addAction(self.show_history_action)
