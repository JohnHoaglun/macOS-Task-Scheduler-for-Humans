...
4. **Load normalization:** existing interval seconds load into the largest exact unit — days, then hours, then minutes, then seconds (e.g. 3600 → `1` + `hours`, 90 → `90` + `seconds`, 93600 → `1` + `days`). Non-exact values keep the smallest unit.
