...
| 3 | 3A `faster` | `MainWindow` / `gui/app.py` composition: proxy mapping, controls, empty states, menu/context actions, reveal/copy handlers, JSON transfer wiring, focused window tests. | All view→source mapping and action-eligibility flows pass real offscreen Qt tests. | 1A, 1C, 2A, 2B |
